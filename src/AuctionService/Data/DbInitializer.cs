...
{
    //static method allows use inside another class without new init of DbInitializer class
    public static void InitDb(WebApplication app)
    {
        //using keyword allows framework to dispose services used inside the scope created here after using the method
    ...
    //context allows to do things in code with the database
